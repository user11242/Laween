...
export const Scene9Winner: React.FC = () => {
  ...
  // Canonical group — matches rest of video
  const friends = [
    ...
    { rank: 4, name: 'You',           dist: '8.9 km', eta: '19 min', avatar: '#0d7975', arriving: false },
  ];
    ...
    <AbsoluteFill style={{ backgroundColor: '#050714', justifyContent: 'center', alignItems: 'center', opacity: exitOp }}>
      ...
      <div style={{
        ...
        <p style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 30, fontWeight: 600, color: '#5eead4', margin: '14px 0 0' }}>
          Laween picks the fairest place.
        </p>
      </div>
        ...
        <PhoneMockup scale={0.95} drift>
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 24, fontWeight: 900, color: 'white', margin: 0, letterSpacing: '0.04em' }}>THE WINNER</h2>
            </div>
            ...
            <div style={{ padding: '24px 20px 16px' }}>
              <div style={{
                ...
                boxShadow: '0 8px 30px rgba(0,0,0,0.1)', height: 220,
              }}>
                ...
                <div style={{ position: 'absolute', bottom: 18, left: 22 }}>
                  <h3 style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 30, fontWeight: 800, color: 'white', margin: '0 0 4px', textShadow: '0 2px 8px rgba(0,0,0,0.4)' }}>Oliva</h3>
                  <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 15, fontWeight: 800, color: '#5eead4' }}>Winning Destination</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ padding: '8px 20px' }}>
              <p style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 12, fontWeight: 800, color: '#a9a9a9', letterSpacing: '0.15em', margin: '0 0 14px' }}>
                FRIENDS' PROGRESS
              </p>
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <div style={{
                        ...
                        <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 16, fontWeight: 800, color: i === 0 ? 'white' : '#64748b' }}>{f.rank}</span>
                      </div>
                      {/* Avatar */}
                      <div style={{
                        width: 38, height: 38, borderRadius: 19, flexShrink: 0,
                        ...
                        <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 16, fontWeight: 800, color: 'white' }}>{f.name[0]}</span>
                      </div>
                      {/* Name + metrics */}
                      <div style={{ flex: 1 }}>
                        <p style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 14, fontWeight: 800, color: '#1e293b', margin: '0 0 4px' }}>{f.name}</p>
            ...
            <div style={{
              ...
              <div style={{
                background: 'white', border: '2px solid #0d7975', borderRadius: 16, padding: '16px 0',
                display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 10,
              }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0d7975" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/></svg>
                <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 15, fontWeight: 800, color: '#0d7975' }}>TRACK FRIENDS' JOURNEY</span>
              </div>
              <div style={{
                background: '#0d7975', borderRadius: 16, padding: '16px 0',
                display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 10,
                boxShadow: '0 8px 24px rgba(13,121,117,0.3)',
              }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M22 2L11 13M22 2L15 22L11 13L2 9L22 2Z"/></svg>
                <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 15, fontWeight: 800, color: 'white' }}>GET DIRECTIONS</span>
              </div>
              <div style={{ textAlign: 'center', paddingTop: 4 }}>
                <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 14, fontWeight: 700, color: '#a9a9a9' }}>EXIT DISCOVERY</span>
              </div>
            </div>
          </div>
        </PhoneMockup>
