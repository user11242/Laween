 ...
 */
const FEATURES = [
  { label: 'Group Chat', color: '#14b8a6', d: 'M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z', x: -500, y: -260, rot: -5 },
  ...
  { label: 'Outing Session', color: '#14b8a6', d: 'M7 2v11h3v9l7-12h-4l4-8z', x: -600, y: -80, rot: -3 },
  ...
  { label: 'Live Tracker', color: '#14b8a6', d: 'M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z', x: -400, y: 300, rot: -3 },
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 24, fontWeight: 800, color: 'white', letterSpacing: '-0.01em' }}>{item.label}</span>
      </div>
    </div>
  );
};
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#050714', overflow: 'hidden', opacity: exitOp }}>
      <div style={{ position: 'absolute', width: '100%', height: '100%',
        background: 'radial-gradient(ellipse at 50% 50%, rgba(20,184,166,0.08) 0%, transparent 50%)' }} />
      ...
      <div style={{
        ...
        <h1 style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 64, fontWeight: 900, color: 'white', margin: 0,
          textShadow: '0 4px 30px rgba(20,184,166,0.3)', letterSpacing: '-0.02em', lineHeight: 1.15 }}>
          One app. One flow.
        </h1>
