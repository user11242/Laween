    ...
    <AbsoluteFill style={{ backgroundColor: '#050714', justifyContent: 'center', alignItems: 'center', opacity: exitOp }}>
      ...
      <div style={{ transform: `scale(${phoneScale}) translateY(80px)` }}>
        <PhoneMockup scale={0.95} drift>
          ...
          {/* ── LOCKED OUTING IN CHAT — exact locked_outing_screen.jpeg ── */}
          <div style={{
            position: 'absolute', inset: 0, background: '#f8fafb',
            opacity: lockedOp,
          }}>
            {/* Chat header — persistent Weekend Plans identity */}
            <div style={{ backgroundColor: 'white', padding: '52px 14px 12px', display: 'flex', alignItems: 'center', boxShadow: '0 1px 12px rgba(0,0,0,0.04)', zIndex: 10 }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1e293b" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 18l-6-6 6-6" /></svg>
              <div style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: '#f59e0b', display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '0 10px 0 8px' }}>
                <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 16, fontWeight: 800, color: 'white' }}>W</span>
              </div>
              <div style={{ flex: 1 }}>
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0d7975" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: 6 }}>
                <circle cx="12" cy="12" r="10" /><line x1="12" y1="16" x2="12" y2="12" /><line x1="12" y1="8" x2="12.01" y2="8" />
              </svg>
            </div>

            {/* Chat content — naturally continuing the thread */}
            <div style={{ padding: '24px 16px', display: 'flex', flexDirection: 'column', gap: 20 }}>
              
              {/* Previous scroll context - A message from Sarah */}
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, opacity: 0.6, transform: 'translateY(-10px)' }}>
                ...
                <div>
                  ...
                  <div style={{ background: 'white', borderRadius: '16px 16px 16px 4px', padding: '9px 13px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
                    <p style={{ fontFamily: 'Inter,system-ui,sans-serif', fontSize: 15, color: '#1e293b', margin: 0, lineHeight: 1.4 }}>Can't wait to see what wins! 🤞</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                margin: '14px 0 0', // small margin to flow well under Sarah's message
              }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
                  ...
                  <h4 style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 20, fontWeight: 800, color: '#000000', margin: 0 }}>Outing Session</h4>
                </div>
                <p style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 16, color: '#0d7975', fontWeight: 700, margin: '0 0 16px' }}>
                  Destination Locked
                </p>
                <div style={{ height: 1.5, background: '#f1f5f9', margin: '0 0 16px' }} />
                <div style={{
                  background: '#0d6b6e', borderRadius: 20, padding: '14px 0',
                  textAlign: 'center', fontFamily: 'Inter, system-ui, sans-serif', fontSize: 18, fontWeight: 700, color: 'white',
                }}>Winner</div>
              </div>
            ...
            <div style={{
              ...
              padding: '14px 14px 24px', backgroundColor: 'white',
              display: 'flex', alignItems: 'center', gap: 12,
              boxShadow: '0 -2px 10px rgba(0,0,0,0.03)', zIndex: 20
            }}>
              {/* Circular + button */}
              <div style={{ width: 44, height: 44, borderRadius: 22, backgroundColor: '#f1f5f9', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
              </div>

              {/* Text Input Pill */}
              <div style={{ flex: 1, height: 44, borderRadius: 22, border: '1.5px solid #e2e8f0', display: 'flex', alignItems: 'center', padding: '0 18px' }}>
                 <span style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: 16, color: '#94a3b8' }}>Type a message...</span>
              </div>

              {/* Send Button */}
              <div style={{ width: 44, height: 44, borderRadius: 22, backgroundColor: '#62a8a5', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0, opacity: 0.9 }}>
                <svg style={{ marginLeft: -2, rotate: '45deg' }} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
              </div>
            </div>
          </div>
        </PhoneMockup>
