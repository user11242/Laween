...
const ChatBubble: React.FC<{
  ...
  return (
    <div style={{
      ...
      <p style={{
        fontFamily: 'Inter, system-ui, sans-serif', fontSize: 19, fontWeight: 800,
...
const EXTRA_MESSAGES = [
  { name: 'Sara',  color: 'hsl(262, 60%, 68%)', msg: 'Wait, tonight or tomorrow?', delay: 20, x: 280, y: -370, rot: 2 },
  { name: 'Yazan', color: 'hsl(168, 55%, 48%)', msg: 'Just share your location',  delay: 46, x: -290, y:  390, rot: -2.5 },
  { name: 'Omar',  color: 'hsl(217, 65%, 62%)', msg: 'I can pick up Noor',         delay: 58, x:  300, y:  200, rot: 1.5 },];
    ...
    <AbsoluteFill style={{ backgroundColor: '#050714', overflow: 'hidden', opacity: exitOp }}>
      ...
      <div style={{
        ...
        background: frame < pushFrame
          ? 'radial-gradient(ellipse at 50% 45%, rgba(20,184,166,0.03) 0%, transparent 50%)'
          : `radial-gradient(ellipse at 50% 44%, rgba(20,184,166,${0.03 + logoPulse * 0.3}) 0%, transparent 55%)`,
      }} />
      ...
      {frame >= pushFrame && (
        <div style={{
          ...
          <div style={{
            ...
            background: `radial-gradient(circle, rgba(20,184,166,${logoPulse}) 0%, rgba(20,184,166,${logoPulse * 0.3}) 40%, transparent 65%)`,
            borderRadius: '50%',
          }} />
          <Img src={staticFile('app_pin_logo.png')} style={{
            width: 210, height: 210,
            filter: 'drop-shadow(0 20px 60px rgba(20,184,166,0.5)) drop-shadow(0 4px 12px rgba(0,0,0,0.3))',
          }} />
        </div>
      )}
      ...
      <div style={{
        ...
        <h1 style={{
          fontFamily: 'Inter, system-ui, sans-serif', fontSize: 72, fontWeight: 900, color: 'white',
          margin: 0, textAlign: 'center', letterSpacing: '-0.02em',
          textShadow: '0 4px 40px rgba(20,184,166,0.2)',
          opacity: titleOp, transform: `translateY(${titleY}px)`,
        }}>
          One chat. One plan.
        </h1>
        <p style={{
          fontFamily: 'Inter, system-ui, sans-serif', fontSize: 36, fontWeight: 700,
          color: '#5eead4', margin: '16px 0 0', textAlign: 'center',
