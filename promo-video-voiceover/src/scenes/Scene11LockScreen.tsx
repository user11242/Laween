        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              backgroundColor: '#006D77', // Primary brand teal
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1, minWidth: 0, paddingTop: 2 }}>
                  <p style={{ fontFamily: 'Outfit, system-ui, sans-serif', fontSize: 15, fontWeight: 800, color: 'white', margin: '0 0 2px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Oliva Restaurant a...</p>
                ...
                {users.map((u, i) => (
                  <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', padding: '0 2px' }}>
                      <span style={{ fontFamily: 'Outfit, system-ui, sans-serif', fontSize: 13, fontWeight: 800, color: 'white' }}>{u.name}</span>
                    ...
                    <div style={{ position: 'relative', height: 16, display: 'flex', alignItems: 'center' }}>
                      {/* Dark track */}
                      <div style={{ position: 'absolute', left: 0, right: 0, height: 3, borderRadius: 1.5, backgroundColor: '#005058' }} />
                      {/* Filled track */}
                      ...
                      <div style={{
                        ...
                        <span style={{ fontFamily: 'Outfit, system-ui, sans-serif', fontSize: 9, fontWeight: 900, color: '#006D77' }}>{u.letter}</span>
                      </div>
                    </div>
                  </div>
                ))}
